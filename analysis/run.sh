...
macroRun -m configs/macros/RunCutflow.json -p configs/plots/Nominal1D.json -c configs/cuts/SR.json -s configs/samples/fourteenthrun/2018/signal_EWKino.json -o plots_SR_fourteenthrun_2018_EWKino_200_190_180.root
